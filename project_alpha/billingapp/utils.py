...
def update_products_from_invoice(invoice_data_processed, 
    ...
    for item in invoice_data_processed['items']:
        ...
        #Updates the product_cost_price. Can be useful in case of Purchase
        product.product_cost_price = item['invoice_rate_with_gst']
        product.save()
...
#Updates the product inventory. Can be useful in case of Purchase
