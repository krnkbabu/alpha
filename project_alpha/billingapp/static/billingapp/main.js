...
function initialize_fuse_customers_search_bar() {
    ...
    $(".customer_search_area").focusin(function() {
        console.log("DISPLAY CUSTOMER SEARCH");
    ...
    $(document).on('focusin click',function(e) {
        // To hide #customer_search_bar when not near #customer_search_bar or .customer_search_area.
...
function initialize_fuse_customers () {
    // fetch customer data
    $.getJSON( "/billingapp/customersjson", function(data) {
        //console.log(data);
        ...
        // Get references to input and datalist
        var searchInput = $('#customer-name-input');
        var suggestionsDatalist = $('#suggestions');
        ...
        searchInput.on('input', function () {
            ...
            // Use Fuse.js to get suggestions based on the input value
            var results = fuse_customers.search(inputValue);
            ...
            $.each(results,function (index, result) {
                var option = $('<option>').val(result.customer_name);
...
function product_result_to_domstr(result) {
    ...
    "<div>"+ result['product_code'] + " | " + result['product_name'] + "</div>" +
...
function initialize_fuse_products () {
    // fetch customer data
    $.getJSON( "/billingapp/productsjson", function( data ) {
